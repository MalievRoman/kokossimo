...
## 6. Чек-лист для тестирования (QA)
...
*Документ подготовлен для QA-инженера проекта Kokossimo. При изменении API эндпоинтов или форматов ответов документ следует обновлять.*
