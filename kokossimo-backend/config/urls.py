...
urlpatterns = [
    ...
    path('api/auth/addresses/', saved_delivery_addresses),
    path('api/auth/addresses/<int:address_id>/', saved_delivery_address_detail),
    path('api/cart/', user_cart),
    path('api/cart/merge/', merge_user_cart),
    path('api/favorites/', user_favorites),
    path('api/favorites/merge/', merge_user_favorites),
    ...
    path('api/orders/<int:order_id>/refresh-payment/', refresh_order_payment),
